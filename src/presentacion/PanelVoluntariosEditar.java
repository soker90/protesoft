...
public class PanelVoluntariosEditar extends PanelP {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        boolean e = GestorVoluntarios.ModificarVoluntario(this.id, txtDni.getText(), 
        ...
        PanelVoluntariosLista pnlVoluntario = new PanelVoluntariosLista();
        FormInicio.pnlPrincipal.add(pnlVoluntario,"menu2");
        CardLayout paletas = (CardLayout)(pnlVoluntario.getLayout());
        FormInicio.pnlPrincipal.remove(FormInicio.pnlActual);
        FormInicio.pnlActual = pnlVoluntario;
